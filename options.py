...
current_articles_path_frozen_kmeans_future = current_articles_path[0:-2]+'_frozen_kmeans_future.p'
current_articles_path_frozen_kmeans_past = current_articles_path[0:-2]+'_frozen_kmeans_past.p'
